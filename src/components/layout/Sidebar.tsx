...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:w-[15rem] lg:flex-col" style={{ background: 'linear-gradient(to bottom, color-mix(in srgb, var(--surface) 94%, var(--primary)), var(--surface), color-mix(in srgb, var(--surface-secondary) 40%, var(--surface)))', borderRight: '1px solid var(--border)' }}>
      {/* Logo */}
              ...
              className={cn(
                ...
                isActive
                  ? isBiz
                    ...
                    : "bg-[#eef0ff] text-[#4C5CFF] dark:bg-[rgba(123,135,255,0.12)] dark:text-[#7B87FF] border-l-[3px] border-[#4C5CFF] dark:border-[#7B87FF]"
