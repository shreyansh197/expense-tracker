      ...
      {showAdd ? (
        <div className="space-y-3 rounded-lg border border-slate-100 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-800/50">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="mb-1 block text-xs text-slate-500">Amount ({symbol})</label>
              <input
                type="number"
                min="1"
                value={amount}
                ...
                placeholder="0"
                className="w-full rounded border border-slate-200 bg-white px-2.5 py-2 text-sm text-slate-900 focus:border-indigo-500 focus:outline-none dark:border-slate-700 dark:bg-slate-900 dark:text-white"
              />
            </div>
            <div>
              <label className="mb-1 block text-xs text-slate-500">Day of month</label>
              <input
                type="number"
                min="1"
                max="28"
