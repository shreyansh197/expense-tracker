...
export function SettingsGraphic() {
  return (
    ...
    >
      ...
      <rect x="47" y="64" width="6" height="10" rx="2" fill="var(--primary)" opacity="0.15" />
      <rect x="18" y="39" width="10" height="6" rx="2" fill="var(--primary)" opacity="0.15" />
      <rect x="72" y="39" width="10" height="6" rx="2" fill="var(--primary)" opacity="0.15" />
      ...
      <circle cx="14" cy="24" r="3" fill="var(--primary)" opacity="0.10" />
    </svg>
  );
}
