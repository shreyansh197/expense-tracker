...
export function BusinessGraphic() {
  return (
    ...
    >
      ...
      <circle cx="88" cy="22" r="10" fill="var(--accent)" opacity="0.10" />
      <circle cx="92" cy="55" r="3.5" fill="var(--success)" opacity="0.18" />
      <circle cx="14" cy="28" r="3" fill="var(--primary)" opacity="0.12" />

      {/* Small diamond accent */}
      <rect x="80" y="50" width="8" height="8" rx="2" fill="var(--accent)" opacity="0.14" transform="rotate(45 84 54)" />
    </svg>
  );
}
