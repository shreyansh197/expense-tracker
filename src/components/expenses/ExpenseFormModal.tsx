...
export function ExpenseFormModal() {
  ...
  return (
    ...
    >
      <div className="expense-form-modal w-full max-w-md max-h-[90vh] overflow-y-auto rounded-t-2xl border border-slate-100 bg-white p-6 shadow-lg dark:border-slate-800 dark:bg-slate-900 lg:max-h-none lg:overflow-visible lg:rounded-2xl">
        <ExpenseForm
          onSubmit={addExpense}
