      ...
      {stage === "result" && result && (
        <div className="space-y-3">
          ...
          <div className="space-y-2 rounded-xl border p-3" style={{ borderColor: "var(--border)", background: "var(--surface-secondary)" }}>
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium" style={{ color: "var(--text-tertiary)" }}>Amount</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium" style={{ color: "var(--text-tertiary)" }}>Category</span>
            ...
            {result.remark && (
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium" style={{ color: "var(--text-tertiary)" }}>Merchant</span>
